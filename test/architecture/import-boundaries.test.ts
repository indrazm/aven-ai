...
const allowedDependencies: Record<string, ReadonlySet<string>> = {
	...
	utils: new Set(['utils']),
	'libs/config': new Set(['libs/config', 'utils']),
	'libs/provider-clients': new Set(['libs/provider-clients', 'utils']),
	...
	'modules/providers': new Set(['modules/providers', 'libs/config', 'libs/provider-clients', 'utils']),
